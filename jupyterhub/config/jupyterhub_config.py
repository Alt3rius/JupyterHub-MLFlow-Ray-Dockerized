...
c.SystemUserSpawner.image = os.environ['DOCKER_JUPYTER_IMAGE']
c.SystemUserSpawner.network_name = os.environ['DOCKER_NETWORK_NAME']
c.SystemUserSpawner.extra_create_kwargs = {'runtime': 'nvidia'}
c.SystemUserSpawner.remove = True
# c.SystemUserSpawner.environment = {'JUPYTER_ENABLE_LAB': '1'}
c.SystemUserSpawner.default_url = '/lab'
c.SystemUserSpawner.disable_user_config = True
...
#  Default: set()
c.Authenticator.admin_users = {'alt3rius'}
